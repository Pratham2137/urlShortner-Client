  ...
  return (
    <>
      ...
      <div className="block md:hidden divide-y divide-gray-200">
        {urls.map((url) => (
          <div key={url._id} className="p-4 hover:bg-gray-50 transition-colors">
            {/* URL Title */}
            <div className="mb-3">
              <div className="flex items-start gap-2 mb-2">
                <div className="shrink-0 w-8 h-8 bg-linear-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center">
                  <svg className="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                  </svg>
                </div>
                <a href={url.originalURL} target="_blank" rel="noopener noreferrer" className="flex-1 text-sm text-gray-900 hover:text-blue-600 break-all" title={url.originalURL}>
                  {url.originalURL}
                </a>
              </div>
            </div>
            ...
            {/* Short Code */}
            <div
              className="inline-flex items-center gap-2 bg-blue-50 px-3 py-2 rounded-lg cursor-pointer hover:bg-blue-100 transition-colors mb-3 w-full justify-center"
            ...
            <div className="flex items-center justify-between text-sm mb-3">
              <div className="flex items-center gap-1">
                ...
                <span className="font-semibold text-gray-900">{url.clicks.toLocaleString()}</span>
            ...
            <div className="flex gap-2">
              <button
                onClick={() => onEdit(url)}
                className="flex-1 py-2 px-3 bg-blue-50 text-blue-600 hover:bg-blue-100 font-medium text-sm rounded-lg transition-colors flex items-center justify-center gap-1"
              >
              ...
              <button
                ...
                className="flex-1 py-2 px-3 bg-red-50 text-red-600 hover:bg-red-100 font-medium text-sm rounded-lg transition-colors flex items-center justify-center gap-1"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <tr key={url._id} className="hover:bg-gray-50 transition-colors duration-150">
                <td className="px-6 py-4">
                  <div className="flex items-center">
                    <div className="shrink-0 w-10 h-10 bg-linear-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center mr-3">
